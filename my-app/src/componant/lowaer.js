    ...
    <div className="container">
      <div className="d-sm-flex justify-content-between">
        <ul className="header-top__info mb-2 mb-sm-0">
          <li><a href="tel:+01432152323"><span className="align-middle"><i className="ti-mobile"></i></span>0780437773</a></li>
          <li><a href="mailto:info@example.com"><span className="align-middle"><i className="ti-email"></i></span>motasem6236@gmail.com</a></li>
        </ul>
